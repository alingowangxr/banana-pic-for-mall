...
export const en: Translations = {
  ...
  styles: {
    ...
    japaneseDesc: 'Soft and elegant, suitable for cosmetics, stationery, lifestyle goods',
    luxury: 'Luxury Premium',
    luxuryDesc: 'Refined and elegant, suitable for jewelry, boutique, high-end skincare',
    natural: 'Natural Organic',
    naturalDesc: 'Fresh and natural, suitable for food, tea, organic skincare',
    cute: 'Cute & Adorable',
    cuteDesc: 'Lively and cute, suitable for baby, kids products, pets',
    apple: 'Apple Tech Style',
    appleDesc: 'Minimalist tech, suitable for electronics, wearables, tech accessories',
  },
  models: {
